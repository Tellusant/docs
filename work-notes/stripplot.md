# Example of Stata beeswarm (stripplot)
Beeswarm graphs (stripplots) are excellent for showing a data series when there are 50-300 observations. Beyond 300, use violinplots.
