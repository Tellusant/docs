...
³ **is-value** and **wish-value** are from control theory. The terms are my translation of the Swedish term är-värde & bör-värde, which has a nice ring to it. Properly called actual value and reference (setpoint) values in English. See, e.g., [Stefan Simrock: Control Theory](https://cds.cern.ch/record/1100534/files/p73.pdf).  
