...
<br/>
We therefore [developed a scientific model](https://github.com/Tellusant/docs/blob/main/articles-posts/judgmental-mechanical.md) aligned with time-discrete control theory. This is an example of a so-called P controller, the simplest and most fundamental of control theory constructs.
