...
(The seven philosphies are explicated in this separate document)[predictive-modeling-philosophies.md], but here is a summary.
...
- *Increasing parsimony*. There is intense pressure from executives without statistical training to have many indpendent variables. Therefore models tend to
be less parsimonious and more bloated than necessary [3.22]
- *New areas to pursue*. For example, a model may be intended for strategic purposes, but it is learned that there is also a need for a operational model. Strategic and operational models have little in common. [3.23]
...
Most models perform well if they were developed by thoughtful people without too much rush. Therefore, one cannot expect recommendations to be overly expansive. If they are, maybe the evaluators should be scrutinized. Or maybe the builders and the evaluators come from different philosophical schools (see 1.2) without knowing it.
