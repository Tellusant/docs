...
>The word Bayesian may be ill chosen because it may lead to thoughts astray ("too complicated"). However, the basic idea of adapting beliefs as new evidence arrives is powerful. In the end, one can get proof in a layperson's sense.
...
## Pragmatism
In the tradition of William James and others, pragmatism ties the standing of a hypothesis to its practical consequences. Belief is warranted if it proves reliable in guiding action, solving problems, or integrating experience. Truth, in this view, is not static correspondence but something that emerges through use. 
