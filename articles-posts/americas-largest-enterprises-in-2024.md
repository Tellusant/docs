...
<a href="{{ site.related_sites.canback.url }}" style="color: black; text-decoration: none;"><i>By {{ site.related_sites.canback.name }}</i></a>, <a href="{{ site.company.url }}" style="color: black; text-decoration: none;"><i>Tellusant, Inc.</i>
