...
### [How to Specify and Evaluate (but not Build) Predictive Models](predictive-model-evaluation-framework.md)
Statistical model are often not contextualized in a logical manner and evaluating them becomes a laundry list of observation and questions. Here we suggest a structured approach based on the law of threes.  
